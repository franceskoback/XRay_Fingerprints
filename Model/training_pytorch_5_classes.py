...
#METADATA_SUBSET_PATH= "/dartfs-hpc/rc/home/t/f006cht/code/torch_test/debugging/metadata_1.csv"
#METADATA_SUBSET_PATH= "/dartfs-hpc/rc/home/t/f006cht/code/torch_test/dicom_metadata_no_na.csv"
#METADATA_SUBSET_PATH = "/Users/franceskoback/Documents/research/pytorch_1/metadata_100subset_df.csv"
DICTIONARY_PATH= "/dartfs-hpc/rc/home/t/f006cht/code/torch_test/barcode_to_side_id.dict_new.pkl"


def get_manufacturer_labels(encoder):
    dictionary= pd.read_pickle(open(DICTIONARY_PATH,'rb'))
    print(dictionary, flush=True)
    return dictionary

class CustomImageDataset(Dataset):
    def __init__(self):
        self.img_dir= "/dartfs-hpc/rc/home/t/f006cht/code/torch_test/data"
...
def train_one_epoch(epoch, model, loss_fn, optimizer, loader, device = "cpu"):
    ...
    for batch_idx, (img,label) in enumerate(loader):  
        ...
        labels = Variable(label.to(device).long())
...
#        inputs = img
       ...
       # pred= Variable(pred.to(device).float(),requires_grad=True)
        ...
        #print("epoch loss is")
        #print(epoch_loss)
        # when i did this, it gives a vector, of which train_loss is always the average 
...
def test_one_epoch(epoch, model, loss_fn, loader, len_val, device = "cpu"):
    ...
    for batch_idx, (img,label) in enumerate(loader):    
        ...
        #pred= torch.argmax(outputs,dim=1)
        #pred= Variable(pred.to(device).float())
